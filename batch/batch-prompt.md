...
Use WebSearch for current salaries (Glassdoor, Levels.fyi, Blind), company comp reputation, role demand trends. Table with data and cited sources. If no data, say so.
...
| 7 | pdf | emoji | `Y` or `N` | Whether PDF was generated |
